...
fieldnamesori = ["Num", "Own_Ori"]


fieldnameAct = ["Num", "Actor"]

with open('Sim_Live_Data/OS_Data.csv', 'w') as csv_file:
    csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
    csv_writer.writeheader()

with open('Sim_Live_Data/OS_Data_Row.csv', 'w') as csv_file:
    csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnameAct)
    csv_writer.writeheader()
...
with open('Sim_Live_Data/Ori.csv', 'w') as csv_file:
    csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesori)
    csv_writer.writeheader()
...
def OS_find_gps_port_value(actor, port_type, port_name_ls,n):
    ...
    if key1 == 0:
        ...
        with open('Sim_Live_Data/OS_Data_Row.csv', 'a') as csv_file:
            csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnameAct)
...
def find_ori_port_value(actor, port_type, port_name_ls,n):
    port_list = actor[port_type]
    num_port = len(port_list)
    num_port_name = len(port_name_ls)
    orientation = []
    ...
    with open('Sim_Live_Data/Ori.csv', 'a') as csv_file:
        csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesori)
                        ...
                        if actor7 != None:
                            if actor7 != None:
                                ...
                                # elif actor['clazz'].__contains__('TypedSixDOFActor'):
                                    ...
                                    gps_gunnerus_orientation = find_ori_port_value(actor7, 'output', Ori_port_gps_name_ls,num)
