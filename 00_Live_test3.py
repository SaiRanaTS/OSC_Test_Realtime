...
with open('Sim_Live_Data/ori/OriOS.csv', 'w') as csv_file:
    csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriOS)
    csv_writer.writeheader()

with open('Sim_Live_Data/ori/OriTS1.csv', 'w') as csv_file:
    csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriTS1)
    csv_writer.writeheader()

with open('Sim_Live_Data/ori/OriTS2.csv', 'w') as csv_file:
    csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriTS2)
    csv_writer.writeheader()

with open('Sim_Live_Data/ori/OriTS3.csv', 'w') as csv_file:
    csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriTS3)
    csv_writer.writeheader()

with open('Sim_Live_Data/ori/OriTS4.csv', 'w') as csv_file:
    csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriTS4)
    csv_writer.writeheader()

with open('Sim_Live_Data/ori/OriTS5.csv', 'w') as csv_file:
...
def find_ori_port_valueOS(actor, port_type, port_name_ls,n):
    ...
    with open('Sim_Live_Data/ori/OriOS.csv', 'a') as csv_file:
        csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriOS)
        ...
        for j in range(num_port):
            ...
            if port_name == port_name_ls[i]:
                if port_name == "ORIENTATION".upper():
                    ...
                    break
    # print('OrintationOS: ', math.degrees(orientation[-1]))
    with open('Sim_Live_Data/ori/OriTS1.csv', 'a') as csv_file:
        csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriTS1)
        ...
        for j in range(num_port):
            ...
            if port_name == port_name_ls[i]:
                if port_name == "ORIENTATION".upper():
                    ...
                    break
    # print('OrintationOS: ', math.degrees(orientation[-1]))
    with open('Sim_Live_Data/ori/OriTS2.csv', 'a') as csv_file:
        csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriTS2)
        ...
        for j in range(num_port):
            ...
            if port_name == port_name_ls[i]:
                if port_name == "ORIENTATION".upper():
                    ...
                    break
    # print('OrintationOS: ', math.degrees(orientation[-1]))
    with open('Sim_Live_Data/ori/OriTS3.csv', 'a') as csv_file:
        csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriTS3)
        ...
        for j in range(num_port):
            ...
            if port_name == port_name_ls[i]:
                if port_name == "ORIENTATION".upper():
                    ...
                    break
    # print('OrintationOS: ', math.degrees(orientation[-1]))
    with open('Sim_Live_Data/ori/OriTS4.csv', 'a') as csv_file:
        csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriTS4)
...
def find_ori_port_valueTS5(actor, port_type, port_name_ls, n):
        ...
        for j in range(num_port):
            ...
            if port_name == port_name_ls[i]:
                if port_name == "ORIENTATION".upper():
                    ...
                    break
    # print('OrintationOS: ', math.degrees(orientation[-1]))
    with open('Sim_Live_Data/ori/OriTS5.csv', 'a') as csv_file:
        csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnamesoriTS5)
    ...
    # data0 = pd.read_csv('Sim_Live_Data/OS_Data.csv')
    # x00 = data0['Num']
    # numberiii = len(x00) - 1
    # print('numckh',numberiii)
    #
    # if numberiii % 2== 0:
    #     with open('Sim_Live_Data/OS_Data.csv', 'a') as csv_file:
    #         csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
    #
    #         info = {
    #             "Heading(Deg)": math.degrees(orientation[-1]),
    #         }
    #         csv_writer.writerow(info)
