...
country_path = r'/Users/sairana/Documents/Project0/Collision_Avoid/OSC_Test_Realtime/map_test/norway.csv'
...
f = px.choropleth(df,locationmode='country names',locations=df['country'],scope='europe',color=df['country'])
