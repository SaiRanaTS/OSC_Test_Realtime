...
# path = 'Simulation_Data/time.xlsx'  # D1R2, D2R1-2, F1R1-2, F4R1-5, F5R1-4
...
img = plt.imread('Plotter_Background/dc_OSC_bac.png')
fig, ax = plt.subplots()
...
# ax.imshow(img, extent=[-5000, 10000, -2400, 4500], alpha=0.96)
# plt.xlim([-7000, 10000])
# plt.ylim([-2400, 4500])
...
def update(frame):
    ...
    dataoriTS1 = pd.read_csv('Sim_Live_Data/ori/OriTS1.csv')
    xo11 = dataoriTS1['Num']
    ...
    # z1 = 10 * sine_degt1
    # p1 = 10 * cos_degt1
    # Pio = plt.quiver(2500, 550, z1, p1, scale=110, color='white', pivot='middle')
    ...
    dataoriTS2 = pd.read_csv('Sim_Live_Data/ori/OriTS2.csv')
    xo22 = dataoriTS2['Num']
    ...
    dataoriTS3 = pd.read_csv('Sim_Live_Data/ori/OriTS3.csv')
    xo33 = dataoriTS3['Num']
    ...
    dataoriTS4 = pd.read_csv('Sim_Live_Data/ori/OriTS4.csv')
    xo44 = dataoriTS4['Num']
    ...
    dataoriTS5 = pd.read_csv('Sim_Live_Data/ori/OriTS5.csv')
    xo55 = dataoriTS5['Num']
